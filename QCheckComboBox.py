#!/bin/python3
# Taken from https://github.com/Hizoka76/QCheckComboBox, accessed on 01/02/2025
...
class QCheckComboBox(QComboBox):
    ...
    def currentText(self, Separator=', '):
        ...
        return Separator.join(self.currentSelected())
        
        
    #========================================================================
    def currentSelected(self):
        """Função para devolver os itens selecionados"""
